...
public class OKHttpHelper {
    ...
    private static Map<String, String> getHeaderMap() {
        String access_key = "HPFPZ4CGZ3";
        String access_secret = "7RV3TL5J7KGNGICUJ80IVDOVFED5S904A0NI5GGC871I4P3I7R";
    ...
    private static String getTaskInfo() {
        String url = "https://tcs.bytedance.net/api/v2/task_info/";
        Map<String, Object> params = Maps.newHashMap();
        params.put("project_id", "6595391663969927693");
    ...
    private static String createTask() {
        String url = "https://tcs.bytedance.net/api/v2/create_task/";
    ...
    private static String auth() {
        String url = "https://content.bytedance.net/apis/test/v1/auth/";
        Map<String, String> headers = getHeaderMap();
